 ...
 */ !(function (t) {
  ...
  function (t, e, n) {
    ...
    function yt(t) {
      ...
      if (
        (C
          ? ((A = N.limitAffectedElements), (S = x), (R = u(N)))
          : (S = R = u({ id: _, selector: I, selectorGuids: T })),
        n && b)
      ) {
        var L = r && (R || !0 === b) ? [r] : c(x);
        if (R) {
            ...
            switch (u) {
              ...
              case h.EventBasedOn.PAGE:
                var R = ut(),
                  ...
                  x = R.scrollWidth,
                  L = R.scrollHeight;
                w = O ? Math.min(N + m, x) / x : Math.min(C + T, L) / L;
                break;
    ...
    r.define(
      ...
      (t.exports = function (t, e) {
        var n,
          ...
          w = t(document);
        function A() {
          (n = f && r.env("design")), (u = w.find(p)).each(S);
        }
        function S(e, i) {
          var u = t(i),
            s = t.data(i, p);
          s ||
            ...
            (s.mouseUpOutside = (function (e) {
              e.mouseUpOutside && w.off(T, e.mouseUpOutside);
              return c(function (n) {
                if (e.open) {
                  var i = t(n.target);
                  ...
                  return function (e) {
                    if (!n && !l && t.open)
                      switch (
                        ...
                        case o.ESCAPE:
                          return x(t), t.toggle.focus(), e.stopPropagation();
                        case o.ARROW_RIGHT:
                        case o.ARROW_DOWN:
                          return (
              ...
              s.el.on(
                ...
                (function (t) {
                  return c(function (e) {
                    ...
                    return o || x(t), e.stopPropagation();
                  });
                })(s)
              ),
              s.toggle.on(T, E),
        ...
        function C(e) {
          if (!e.open) {
            ...
            var i = r.env("editor");
            n || w.on(T, e.mouseUpOutside),
              e.hovering && !i && e.el.on(I, e.mouseLeave),
              e.hovering && i && w.on(m, e.mouseMoveOutside),
        ...
        function x(t) {
          ...
          if (t.open && (!t.config.hover || !t.hovering || r)) {
            ...
            if (
              (h.outro(0, t.el[0]),
              w.off(T, t.mouseUpOutside),
              w.off(m, t.mouseMoveOutside),
  ...
  events: {
    e: {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "5e8a723dc663ab416e6bfe24|fb7758c4-2ce2-02d2-14cc-8f8e5439fd4a",
      },
      config: [
        {
    ...
    "e-8": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "5e8b5d6ceaa78551f2d9d3d9|b874e546-efce-c407-e18e-9d5cf909525f",
      },
      config: [
        {
          continuousParameterGroupId: "a-3-p",
    ...
    "e-9": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "5e927c7d4660cb5d9cdf142f|17ac18b5-161b-07f2-842a-a33f4d0523b9",
      },
      config: [
        {
          continuousParameterGroupId: "a-3-p",
    ...
    "e-24": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "5e8a723dc663ab416e6bfe24|bc3aafcd-95c7-9cd2-d74b-c9a98dcadbd9",
      },
      config: {
        loop: false,
        playInReverse: false,
    ...
    "e-46": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "1b0214a5-408b-540b-64df-3835fd7e4438",
      },
      config: {
        loop: false,
        playInReverse: false,
    ...
    "e-48": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "1b0214a5-408b-540b-64df-3835fd7e443a",
      },
      config: {
        loop: false,
        playInReverse: false,
    ...
    "e-50": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "1b0214a5-408b-540b-64df-3835fd7e443c",
      },
      config: {
        loop: false,
        playInReverse: false,
    ...
    "e-52": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "1b0214a5-408b-540b-64df-3835fd7e443e",
      },
      config: {
        loop: false,
        playInReverse: false,
    ...
    "e-54": {
      ...
      action: {
        id: "",
        actionTypeId: "GROW_EFFECT",
        config: { actionListId: "growIn", autoStopEventId: "e-55" },
        instant: false,
      },
      mediaQueries: ["main"],
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "1b0214a5-408b-540b-64df-3835fd7e4441",
      },
      config: {
        loop: false,
        playInReverse: false,
    ...
    "e-56": {
      ...
      mediaQueries: ["main"],
      target: {
        selector: ".modal-wrapper.project",
        originalId:
          "5e8a723dc663ab416e6bfe24|46ba3cb4-fc4a-39ca-b765-21f20fb70eb1",
        appliesTo: "CLASS",
      },
      config: {
        loop: false,
    ...
    "e-58": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "5e8a723dc663ab416e6bfe24|33bd0df0-f893-c11d-6f02-decffed53f6b",
      },
      config: {
        loop: false,
        playInReverse: false,
    ...
    "e-60": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "5e8e04315d4b8903b29517a5|9e5ff383-cf25-2f57-79b6-1e85091d80f7",
      },
      config: [
        {
          continuousParameterGroupId: "a-3-p",
    ...
    "e-63": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "5e96011ab907e76fff336638|1f183763-10e3-9fff-d9b9-766c91764d73",
      },
      config: {
        loop: false,
        playInReverse: false,
    ...
    "e-65": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "5e960613ba7c148552238377|1f183763-10e3-9fff-d9b9-766c91764d73",
      },
      config: {
        loop: false,
        playInReverse: false,
    ...
    "e-67": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "5e96271775cfea35cf33d77b|1f183763-10e3-9fff-d9b9-766c91764d73",
      },
      config: {
        loop: false,
        playInReverse: false,
    ...
    "e-69": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "5e8e052fa900f51efca3ca55|17ac18b5-161b-07f2-842a-a33f4d0523d8",
      },
      config: {
        loop: false,
        playInReverse: false,
    ...
    "e-71": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "5e927c7d4660cb5d9cdf142f|5a8b8f09-d259-86e6-1c31-b57b69680df5",
      },
      config: {
        loop: false,
        playInReverse: false,
      ...
      createdOn: 1586901471349,
    },
  },
  actionLists: {
    "a-3": {
      id: "a-3",
      title: "Projects Horizontal Scroll",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: ["d5b64038-3653-9159-d6e1-97161b0f65f7"],
                    },
                    xValue: 0,
                    xUnit: "%",
                    yUnit: "PX",
      ...
      createdOn: 1586018996245,
    },
    "a-4": {
      id: "a-4",
      title: "Eye follow along",
      continuousParameterGroups: [
        {
          id: "a-4-p",
          type: "MOUSE_X",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    duration: 500,
                    target: {
                      id: "5e8a723dc663ab416e6bfe24|082b8625-7c7e-2fd3-3c54-8dfbd7bde2f0",
                    },
                    xValue: -45,
                    xUnit: "%",
                    yUnit: "PX",
